...
func (c *chatServiceClient) SaveMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Response, error) {
...
func (c *chatServiceClient) GetUserThreads(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*ThreadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedChatServiceServer) SaveMessage(context.Context, *Message) (*Response, error) {
...
func _ChatService_GetUserThreads_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetUserThreads(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
