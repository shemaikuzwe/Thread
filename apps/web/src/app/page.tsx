    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto text-center space-y-8">
          <div className="space-y-4 max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Thread is the ultimate communication platform for modern teams. Chat, video call, and
              collaborate in one secure place.
            </p>
          </div>
      ...
      <section className="py-12 border-y bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            <div className="text-2xl font-bold flex items-center gap-2">Vercel</div>
            <div className="text-2xl font-bold flex items-center gap-2">Microsoft</div>
            <div className="text-2xl font-bold flex items-center gap-2">Google</div>
          </div>
        </div>
      </section>

      <section id="features" className="lg:py-24 lg:px-6 bg-background overflow-hidden relative">
        <div className="max-w-5xl mx-auto space-y-24">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-bold">Everything you need to collaborate</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Powerful features designed to keep your team aligned and moving forward.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Instant messaging with rich text, file sharing, and thread support to keep
                conversations organized. Catch up on what you missed with intelligent history.
              </p>
              <ul className="space-y-3 pt-4">
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-blue-500" /> <span>Rich text editor</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-blue-500" /> <span>File attachments</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-blue-500" /> <span>Emoji reactions</span>
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-24">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Crystal clear video conferencing for standups, client meetings, and quick syncs with
                your team. Share your screen and collaborate in real-time.
              </p>
              <ul className="space-y-3 pt-4">
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-purple-500" /> <span>4K Video Quality</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-purple-500" /> <span>Screen Sharing</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-purple-500" /> <span>Noise Cancellation</span>
                </li>
              </ul>
            </div>
            <div className="flex-1 relative group w-full">
      ...
      <footer className="py-12 px-6 border-t bg-background">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm text-muted-foreground">© 2025 Thread Inc. All rights reserved.</p>
